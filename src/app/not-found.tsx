  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] flex items-center justify-center px-6">
      <div className="text-center">
        <div className="w-20 h-20 rounded-3xl bg-indigo-600 flex items-center justify-center mx-auto mb-6 shadow-lg">
          <span className="text-white font-bold text-3xl" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>A</span>
        </div>
        <p className="text-6xl font-bold text-[#4F46E5] mb-3" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>404</p>
